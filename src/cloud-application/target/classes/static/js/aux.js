...
function fillAnomaliesTable(data) {
    ...
    anomalies.forEach(anomaly => {
        ...
        var anomalyData = [
            anomaly.prob,            // Probability column
            anomaly.classification,  // Classification column
            anomaly.timestamp        // Detected At column
        ];

        tableData.push(anomalyData); // Add the row to the table data
    });

    anomaly_table.rows.add(tableData).draw(); // Add all rows to the table and redraw
}
